...
proposed `origNNN start:`/`end:` rows (each naming the sync point it is derived from —
start from the first anchor, end from the last — plus `confidence n/10`), and `note QUESTION:` rows wherever
